...
class BottomMenuItem {
  const BottomMenuItem({required this.label, required this.icon});
...
class _BottomMenuButton extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    // The selected pill is the app's most visible brand surface, so it comes
    // from the accent rather than a fixed blue.
    final accent = appColorsOf(context).accent;
